...
function Footer() {
  return (
    <section className="relative overflow-hidden py-10 bg-white border border-t-2 border-t-gray-200">
            ...
            <div className="flex h-full flex-col justify-evenly items-center">
              ...
              <div>
                <p className="text-sm text-gray-600">
                  &copy; Copyright 2024. All Rights Reserved by Aditya Singh
                  Patel.
                </p>
              </div>
            </div>
          ...
          <div className="w-full p-3 md:w-1/2 lg:w-2/12">
            <div className="h-full">
              ...
              <ul>
                <li className="mb-2">
                  <Link
                    className="font-medium text-sm text-gray-900 hover:text-gray-700"
                    to="/"
                  >
                    Features
                  </Link>
